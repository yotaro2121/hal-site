...
3. 写真をドラッグして追加/差し替え、作品名・キャプションを入力、↑↓で並べ替え
4. 「保存」を押す
...
陶芸家・伊勢崎陽太郎さんのポートフォリオ／ブランドサイト。コンセプトは **「画像を、焼く（IMAGES, FIRED）」** — AIが生成したイメージを陶にオーバーグレーズ転写し焼成することで、無限に複製できたはずのイメージを「二度と再生成できない一点物」に固定する、という世界観。
